...
const settings = defineSettings([
  ...
  },
  {
    ...
    default: "24429042323,28644538672,33030477060"
  },
  {
    type: "input-text",
    name: "dailyPlaybacks",
    label: "每日通关回放文件随机池（同一关卡逗号分隔，不同关卡分号分隔）",
    default: "通关回放1.json,通关回放2.json;30秒按1通关.json;30秒按2通关.json"
  },
  {
    type: "input-text",
    name: "dailyLimit",
  ...
  {
    type: "checkbox",
    name: "closeStageDialog",
    label: "执行通关回放前关闭游戏说明对话框",
    default: true
  },
  {
    type: "checkbox",
